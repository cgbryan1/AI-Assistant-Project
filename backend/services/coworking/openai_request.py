...
from backend.models.coworking.openai_request import GeneralAIResponse, NoSuchPathException
...
class AIRequestService:
    ...
    def determine_request(self, user_prompt: str):
        ...
        try:
            ai_response: GeneralAIResponse = self._openai_svc.prompt(system_prompt=context, user_prompt=user_prompt, response_model=GeneralAIResponse)
        except ValueError:
